...
````
npm init
npm i express express-validator winston dotenv sequelize sequelize-cli mysql2 cookie-parser jsonwebtoken cors multer dayjs bcrypt web-push swagger-ui-express swagger-parser
